...
public class Result
{
    ...
    public static Result<T> Forbidden<T>(AuthenticationProperties properties, params string[] authenticationSchemes) => new(new ForbidResult(authenticationSchemes, properties), default);
